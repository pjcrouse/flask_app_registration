...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////Users/pat/Desktop/flask_demo/data.db'
db = SQLAlchemy(app)
...
class RegisterForm(FlaskForm):
    ...
    def validate_username(form, field):
        print('Field data from username check is {}'.format(field.data))
        if User.query.filter_by(username=field.data).first():
            raise ValidationError('Username already exists')

    def validate_email(form, field):
        print('Field data from email check is {}'.format(field.data))
